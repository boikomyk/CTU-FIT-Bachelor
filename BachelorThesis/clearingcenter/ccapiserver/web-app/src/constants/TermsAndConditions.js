 ...
 * @return {Object}
 */
export default function getTermsAndConditions() {
  return (
    <div>
      <h2>Terms and Conditions</h2>

      <p>
        <b>Last updated:</b> May 04, 2019
      </p>

      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the clearing.center website (the "Service")
        operated by Clearing Center Company ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        are not owned or controlled by Clearing Center Company.
      </p>

      <p>
        Clearing Center Company has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree
        that Clearing Center Company shall not be responsible or liable,
      ...
      <p>
        ...
        of Czech Republic, without regard to its conflict of law provisions.
      </p>
